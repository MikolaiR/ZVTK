<template>
  <AdminLayout>
    <div class="mb-6 flex items-center justify-between">
      <h2 class="text-lg font-semibold">Редактировать компанию</h2>
      <Link href="/admin/companies" class="text-sm text-gray-600 hover:text-gray-900">← Назад к списку</Link>
    </div>
    ...
    <div class="rounded-lg border bg-white p-6 max-w-xl">
      ...
      <div class="flex gap-3">
        ...
        <Link href="/admin/companies" class="rounded-md border px-4 py-2 text-sm hover:bg-gray-50">Отмена</Link>
      </div>
...
const save = () => {
  router.put(`/admin/companies/${company.value.id}`, form)
}
</script>
